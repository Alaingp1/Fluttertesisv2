...
class _RecuperarContrasenaState extends State<RecuperarContrasena> {
  ...
  Future<List> validarCorreo() async {
    ...
    var url =
        "http://152.173.200.226/pruebastesis/validarCorreo.php?Usuario_correo=$correo";
  ...
  Future editarUsuario() async {
    ...
    var url =
        "http://152.173.200.226/pruebastesis/recuperarContrasena.php?Usuario_correo=$correo";
